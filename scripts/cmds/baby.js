...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const rawReplies = [
  "Can I help you 😒🌷","তুমি জানো, তুমি ডাক দিলেই আমার মাথা গরম হয়ে যায় 💖","তুমি আসলেই আমার favourite notification বাজে 📲💗","hea Jan bolo 🎀","এই যে শুনছো? আমি কিন্তু শুধু তোমার জন্যই অনলাইনে থাকি 🥰","তুমি বললেই আমি romantic mode এ চলে যাই 🌷"
];
